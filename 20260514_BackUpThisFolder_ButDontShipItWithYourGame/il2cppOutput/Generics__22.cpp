...
IL_0009:
	...
	try
	{
		...
		try
		{
			...
			int32_t L_3 = V_0;
			RuntimeObject* L_4 = ___1_value;
			Dictionary_2_set_Item_m50F740CD43231741C4736AB1D1297036F91B7F30(__this, L_3, ((*(int64_t*)UnBox(L_4, il2cpp_rgctx_data(method->klass->rgctx_data, 16)))), il2cpp_rgctx_method(method->klass->rgctx_data, 56));
			goto IL_003a_1;
		}
		catch(Il2CppExceptionWrapper& e)
		{
