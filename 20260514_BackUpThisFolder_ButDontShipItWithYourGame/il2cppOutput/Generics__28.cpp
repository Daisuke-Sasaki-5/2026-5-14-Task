...
IL_0009:
	...
	try
	{
		...
		try
		{
			...
			uint32_t L_3 = V_0;
			RuntimeObject* L_4 = ___1_value;
			Dictionary_2_set_Item_mC3CDC5E2FDB9E05AE642B8164A0117EE7E7F75D1(__this, L_3, ((*(MarkToBaseAdjustmentRecord_t03C041CB56601B46F025C69B899BBAB750201C71*)UnBox(L_4, il2cpp_rgctx_data(method->klass->rgctx_data, 16)))), il2cpp_rgctx_method(method->klass->rgctx_data, 56));
			goto IL_003a_1;
		}
		catch(Il2CppExceptionWrapper& e)
		{
...
IL_0009:
	...
	try
	{
		...
		try
		{
			...
			uint32_t L_3 = V_0;
			RuntimeObject* L_4 = ___1_value;
			Dictionary_2_set_Item_m3712D7E8ED024A3554C1773C95A42DF4AC40ABA1(__this, L_3, ((*(MarkToMarkAdjustmentRecord_t5D12F757E4ECB2EA12EB404228D70FA4DDBD6654*)UnBox(L_4, il2cpp_rgctx_data(method->klass->rgctx_data, 16)))), il2cpp_rgctx_method(method->klass->rgctx_data, 56));
			goto IL_003a_1;
		}
		catch(Il2CppExceptionWrapper& e)
		{
